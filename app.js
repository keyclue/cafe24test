...
var token = {
    headers: {"Authorization": "Bearer iJ9rikPXOpjkvKSe5yFd6F"}
};
...
var findstr = "?start_date=2018-04-04&end_date=2018-04-04&order_status=N10,N20&limit=100";
var orderIdArray = [];
var receiverArray = [];
        ...
        for(var index=0; index<=receiverArray.length-1; index++) {
            client.get(receiverArray[index], token, function(data, response) {
                ...
                new Receiver({
                    ...
                    var csv = json2csvParser.parse(jsonReceiver);
                    //console.log(csv);
